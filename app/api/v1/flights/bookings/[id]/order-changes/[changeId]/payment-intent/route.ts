...
import { createOrderChangePaymentIntentForBooking } from "@/lib/services/flights/flight-order-change.service";
import { flightOrderChangePaymentIntentBodySchema } from "@/lib/validations/flight-order-change.schema";
...
export async function POST(req: NextRequest, ctx: RouteContext) {
  try {
    ...
    const parsed = flightOrderChangePaymentIntentBodySchema.safeParse(json);
    if (!parsed.success) {
